...
- [file.ext:L42 functionName]: WONTFIX — reason: [explanation, cite docs]
- [file.ext:L100 className]: DEFERRED — tracking: [issue link]
- [file.ext:L200 methodName]: QUESTION — [specific question]
